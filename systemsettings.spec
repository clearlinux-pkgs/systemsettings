...
Source0  : https://download.kde.org/stable/plasma/5.25.4/systemsettings-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/systemsettings-5.25.4.tar.xz.sig
...
%prep
%setup -q -n systemsettings-5.25.4
cd %{_builddir}/systemsettings-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659719054
mkdir -p clr-build
pushd clr-build
