...
Version  : 6.3.5
Release  : 114
URL      : https://download.kde.org/stable/plasma/6.3.5/systemsettings-6.3.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.5/systemsettings-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/systemsettings-6.3.5.tar.xz.sig
...
%setup -q -n systemsettings-6.3.5
cd %{_builddir}/systemsettings-6.3.5
pushd ..
cp -a systemsettings-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747195900
mkdir -p clr-build
pushd clr-build
